...
@section("title","المنطاق والاحياء")
@section("link-css")
@endsection
...
@section("content-header")
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">المناطق والاحياء</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route("adminpanel.home.index")}}">الرئيسية</a></li>
                        <li class="breadcrumb-item active">المناطق والاحياء</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    @component('dashboard.layouts.components.spanTag')
                        ...
                        @slot('name') اضافة الاحياء  <i class="fas fa-plus"></i> @endslot
                        @slot('class') btn btn-success float-right mr-1 @endslot
                    @endcomponent


                    @include('dashboard.Cities.addEdit')
...
@section("scripts")
    @include('dashboard.Cities.scripts')
@endsection
